...
public class UpdateProgressDialog extends JDialog
{
	...
	public UpdateProgressDialog(Action cancelUpdateAction)
	{
		...
		getContentPane().add(new JLabel(/*
										 * new
										 * ImageIcon(ResourcesManager.getResources
										 * ().
	...
	protected void updateProgress(int bytesDownloaded)
	{
		...
		statusLabel.setText(String.format("%s of %s (%s/s)", FileUtils.bytesToSize(progressBar.getValue()), FileUtils.bytesToSize(progressBar.getMaximum()), FileUtils.bytesToSize(currentSpeed)));
	}
