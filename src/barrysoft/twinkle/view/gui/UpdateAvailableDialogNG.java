...
public class UpdateAvailableDialogNG extends javax.swing.JDialog
{
	 ...
	 */
	public UpdateAvailableDialogNG(java.awt.Frame parent, boolean modal)
	{
		super(parent, modal);
		initComponents();
	}
	...
	public static void main(String args[])
	{
		...
		java.awt.EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				UpdateAvailableDialogNG dialog = new UpdateAvailableDialogNG(new javax.swing.JFrame(), true);
